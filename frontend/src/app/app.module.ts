...
import { AjouterReclamationModule } from './views/chauffeur/ajouter-reclamation/ajouter-reclamation/ajouter-reclamation.module';
...
@NgModule({
  ...
  imports: [
    BrowserModule,BrowserAnimationsModule,ReactiveFormsModule,CommonModule,AjouterReclamationModule,
